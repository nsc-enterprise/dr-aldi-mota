        ...
        <div className="bg-white rounded-xl shadow-lg border overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-azul-700 to-azul-800 hover:from-azul-800 hover:to-azul-900 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-200 disabled:opacity-50"
            >
